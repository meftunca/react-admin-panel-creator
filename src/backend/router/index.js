...
// import { messaging } from "../../firebase-sw";
...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    navigator.serviceWorker.addEventListener("message", message => {
      const { title, ...rest } = message.data[
        "firebase-messaging-msg-data"
      ].notification;
      const notify = new Notification(title, rest);
