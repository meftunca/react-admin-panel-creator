        ...
        this.setState(
          {
            deleting: true,
            message:
              "Twit başarılı bir şekilde silindi.Birazdan veriler güncellenecek."
          },
          () => this.update()
        );
      } else {
    ...
    <div className={classes.relative}>
      ...
      >
        {data != [] && data[0].code == undefined ? (
          <Fragment>
            {data.map(
              ({ id_str, user, text, retweeted, created_at, entities }, k) => (
                <Fragment key={k}>
                  <ListItem>
                    <ListItemAvatar>
                    ...
                    <ListItemSecondaryAction>
                      <IconButton
                        ...
                        onClick={() =>
                          deleteFunc(
                            retweeted !== false ? retweeted.id_str : id_str
                          )
                        }
                      >
      ...
      <Grid container className={classes.bottomFixParent}>
        {data != [] && data[0].code == undefined && (
