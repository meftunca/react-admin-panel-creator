...
function SignIn(_ref) {
  ...
  var submit = function submit() {
    ...
    axios.post(window.location.origin + ":8000/user-login", data).then(
    /*#__PURE__*/
    function () {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("main", {
    ...
    htmlFor: "login-name"
  }, "Email Yada Kullan\u0131c\u0131 ad\u0131"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core_Input__WEBPACK_IMPORTED_MODULE_8___default.a, {
    id: "login-name",
    name: "name",
    autoComplete: "email",
    autoFocus: true
...
/* harmony default export */ __webpack_exports__["default"] = (_material_ui_core_styles_withStyles__WEBPACK_IMPORTED_MODULE_11___default()(styles)(SignIn));
